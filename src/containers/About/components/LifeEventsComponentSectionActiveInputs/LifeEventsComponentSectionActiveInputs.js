...
import "./LifeEventsComponentSectionActiveInputs.css";

export const LifeEventsComponentSectionActiveInputs = (props) => {
  const [input_1, setInput_1] = useState(
    Array.isArray(props.componentArguments) ? "" : props.componentArguments
  );
  ...
  switch (props.activeInputs) {
    case 1:
      return (
        <>
          <div
            className={"LifeEventsComponentSectionActiveInputs__input__wrapper"}
          >
            <input
              className={"LifeEventsComponentSectionActiveInputs__input"}
              value={input_1}
          ...
          <div
            className={
              "LifeEventsComponentSectionActiveInputs__controllButtons"
            }
          >
            <div
              className={"LifeEventsComponentSectionActiveInputs__cancelButton"}
              onClick={() => {
                props.toggleActiveComponent(false);
              }}
            >
            ...
            {input_1.trim() === "" ? (
              <div
                className={
                  "LifeEventsComponentSectionActiveInputs__saveButton-disabled"
                }
              >
                <span>Save</span>
              </div>
              ...
              <div
                className={"LifeEventsComponentSectionActiveInputs__saveButton"}
                onClick={() => {
                  props.addReducer(
                    [input_1.trim()],
                    props.fieldReducer,
