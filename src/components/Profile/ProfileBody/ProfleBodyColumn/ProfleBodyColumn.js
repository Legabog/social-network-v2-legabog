...
import ProfileBodyColumnComponent from "./ProfileBodyColumnComponent/ProfileBodyColumnComponent";
import "./ProfleBodyColumn.css";

const ProfleBodyColumn = (props) => {
...
export default ProfleBodyColumn;
