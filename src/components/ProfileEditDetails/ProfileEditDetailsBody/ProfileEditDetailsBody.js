...
import ProfileEditDetailsBodySection from "./ProfileEditDetailsBodySection/ProfileEditDetailsBodySection";

const ProfileEditDetailsBody = (props) => {
  return (
...
export default ProfileEditDetailsBody;
