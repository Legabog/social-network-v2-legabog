...
import "./FamilyAndRelationshipsComponentSectionActiveInputs.css";

const FamilyAndRelationshipsComponentSectionActiveInputs = (props) => {
    ...
    case 1:
      return (
        <>
          <div
            className={
              "FamilyAndRelationshipsComponentSectionActiveInputs__input__wrapper"
            }
          >
            <input
              className={
                "FamilyAndRelationshipsComponentSectionActiveInputs__input"
              }
              value={input_1}
          ...
          <div
            className={
              "FamilyAndRelationshipsComponentSectionActiveInputs__controllButtons"
            }
          >
            <div
              className={
                "FamilyAndRelationshipsComponentSectionActiveInputs__cancelButton"
              }
              onClick={() => {
                props.toggleActiveComponent(false);
              }}
            ...
            {input_1.trim() === "" ? (
              <div
                className={
                  "FamilyAndRelationshipsComponentSectionActiveInputs__saveButton-disabled"
                }
              >
                <span>Save</span>
              </div>
              ...
              <div
                className={
                  "FamilyAndRelationshipsComponentSectionActiveInputs__saveButton"
                }
                onClick={() => {
                  props.addReducer(
                    [input_1.trim()],
                ...
                switch (e.key) {
                  case "Enter":
                    if (
                      ...
                      props.addReducer(
                        [input_1.trim(), input_2.trim(), input_3.trim()],
                        props.fieldReducer,
                        props.activeAccountEmail,
                        props.toggleActiveComponent(false)
                      );
...
export default FamilyAndRelationshipsComponentSectionActiveInputs;
