...
import "./DetailsAboutYouComponentSectionActiveInputs.css";

const DetailsAboutYouComponentSectionActiveInputs = (props) => {
    ...
    case 1:
      return (
        <>
          <div
            className={
              "DetailsAboutYouComponentSectionActiveInputs__input__wrapper"
            }
          >
            <input
              className={"DetailsAboutYouComponentSectionActiveInputs__input"}
              value={input_1}
          ...
          <div
            className={
              "DetailsAboutYouComponentSectionActiveInputs__controllButtons"
            }
          >
            <div
              className={
                "DetailsAboutYouComponentSectionActiveInputs__cancelButton"
              }
              onClick={() => {
                props.toggleActiveComponent(false);
              }}
            ...
            {input_1.trim() === "" ? (
              <div
                className={
                  "DetailsAboutYouComponentSectionActiveInputs__saveButton-disabled"
                }
              >
                <span>Save</span>
              </div>
              ...
              <div
                className={
                  "DetailsAboutYouComponentSectionActiveInputs__saveButton"
                }
                onClick={() => {
                  props.addReducer(
                    [
...
export default DetailsAboutYouComponentSectionActiveInputs;
