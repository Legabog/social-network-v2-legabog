...
import "./PlacesLivedComponentSectionActiveInputs.css";

const PlacesLivedComponentSectionActiveInputs = (props) => {
    ...
    case 1:
      return (
        <>
          <div
            className={
              "PlacesLivedComponentSectionActiveInputs__input__wrapper"
            }
          >
            <input
              className={"PlacesLivedComponentSectionActiveInputs__input"}
              value={input_1}
          ...
          <div
            className={
              "PlacesLivedComponentSectionActiveInputs__controllButtons"
            }
          >
            <div
              className={
                "PlacesLivedComponentSectionActiveInputs__cancelButton"
              }
              onClick={() => {
                props.toggleActiveComponent(false);
              }}
            ...
            {input_1.trim() === "" ? (
              <div
                className={
                  "PlacesLivedComponentSectionActiveInputs__saveButton-disabled"
                }
              >
                <span>Save</span>
              </div>
              ...
              <div
                className={
                  "PlacesLivedComponentSectionActiveInputs__saveButton"
                }
                onClick={() => {
                  props.addReducer(
                    [
...
export default PlacesLivedComponentSectionActiveInputs;
