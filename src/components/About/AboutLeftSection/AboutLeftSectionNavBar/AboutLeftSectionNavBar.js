...
import AboutLeftSectionNavLink from "../AboutLeftSectionNavLink/AboutLeftSectionNavLink";
import "./AboutLeftSectionNavBar.css";

const AboutLeftSectionNavBar = (orops) => {
...
export default AboutLeftSectionNavBar;
